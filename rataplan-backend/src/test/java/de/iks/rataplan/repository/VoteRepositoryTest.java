...
public class VoteRepositoryTest {
    ...
    @ExpectedDatabase(
        value = FILE_PATH + CREATE + "/simple" + FILE_EXPECTED, assertionMode = DatabaseAssertionMode.NON_STRICT
    )
    public void createVoteWithDefaultConfigAndTwoOptions() {
    ...
    @DatabaseSetup(FILE_EMPTY_DB)
    @ExpectedDatabase(
        value = FILE_PATH + CREATE + "/extended" + FILE_EXPECTED, assertionMode = DatabaseAssertionMode.NON_STRICT
    )
    public void createVoteWithExtendedConfigAndOneOption() {
        Vote vote = new Vote(
            new EncryptedString("Coding Dojo", false),
    ...
    @ExpectedDatabase(
        value = FILE_PATH + CREATE + "/simpleWithUser" + FILE_EXPECTED, assertionMode = DatabaseAssertionMode.NON_STRICT
    )
    public void createVoteWithUserAndDefaultConfigAndTwoOptions() {
    ...
    @Test
    @DatabaseSetup(FILE_PATH + GET + "/simpleThreeRequests" + FILE_INITIAL)
    public void getAllVotesByUserId() {
    ...
    public void getAllVotesByUserIdNoVotes() {
    ...
    public void updateVoteShouldFailNoDeadline() {
        Vote vote = voteRepository.findById(1).orElseThrow();
